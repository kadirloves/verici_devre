...
// SICAKLIK ICIN //
#define SX127X_LORA 0b10000000
#define SX127X_SLEEP 0b00000000
#define SX127X_FSK_OOK 0b00000000
#define SX127X_SLEEP 0b00000000
#define SX127X_FSK_OOK 0b00000000
#define SX127X_FSRX 0b00000100
#define SX127X_REG_IMAGE_CAL 0x3B
#define SX127X_TEMP_MONITOR_ON 0b00000000
#define SX127X_TEMP_MONITOR_OFF 0b00000001
...
uint8_t LoRa_transmit(LoRa* _LoRa, uint8_t* data, uint8_t length, uint16_t timeout);
uint8_t LoRa_FastTransmit(LoRa* _LoRa, uint8_t* data, uint8_t length, uint16_t timeout);
